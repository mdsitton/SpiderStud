...
// Based on Andrew Arnott's Nerdbank.Streams Sequence<T> type
...
namespace SpiderStud
{
    ...
    public class SequenceWriter<T> : IBufferWriter<T>, IDisposable
    {
        ...
        private const int MaximumAutoGrowSize = 8000;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SequenceWriter{T}"/> class
        ...
        public SequenceWriter(MemoryPool<T> memoryPool)
        {
        ...
        public SequenceWriter(ArrayPool<T> arrayPool)
        {
        ...
        public static implicit operator ReadOnlySequence<T>(SequenceWriter<T> sequence)
        {
...
#pragma warning restore SA1011 // Closing square brackets should be spaced correctly
            ...
            internal void SetNext(SequenceSegment segment)
            {
                ...
                if (!IsForeignMemory)
                {
                    ...
                    this.Memory = AvailableMemory.Slice(0, Start + Length);
                }
            }
